...
const About = () => {
  return (
    <section id="about" className="py-10 md:py-16 bg-brand-light">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row items-center gap-10">
          ...
          {/* Right Image */}
          <div className="w-full lg:w-1/2 mt-6 md:mt-0 px-4 md:px-0">
            <div className="relative w-full max-w-[240px] sm:max-w-sm mx-auto lg:max-w-none">
              <div className="absolute -inset-4 border border-brand-orange/20 rounded-t-full hidden md:block"></div>
              <img 
                src="https://images.unsplash.com/photo-1559339352-11d035aa65de?auto=format&fit=crop&w=800&q=80" 
                alt="Spot11 Interior" 
                className="w-full h-auto rounded-t-full object-cover shadow-2xl relative z-10 aspect-[4/5] md:aspect-[3/4]"
              />
